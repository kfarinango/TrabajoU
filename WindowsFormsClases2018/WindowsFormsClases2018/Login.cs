...
{
    SqlConnection conectar = new SqlConnection(ConfigurationManager.ConnectionStrings["coneccion"].ConnectionString);
    ...
    public partial class Login : Form
    {
        ...
        {
            conectar.Open();
            SqlCommand consulta = new SqlCommand("Select * From USUARIO WHERE USRIDUSUARIO = '" + txtusuario + "'AND USRCLAVE ='" + txtcontraseña + "'", conectar);
