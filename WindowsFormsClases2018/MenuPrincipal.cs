...
namespace WindowsFormsClases2018
{
    public partial class MenuPrincipal : Form
    {
        ...
        {
            Ejercicios.fAmortizacion formularioNuevo = new Ejercicios.fAmortizacion();
            formularioNuevo.Show();
        }

        private void mantenimientoUsuariosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Ejercicios.fMantenimientoUsuario mantenimientoUsr = new Ejercicios.fMantenimientoUsuario();
            mantenimientoUsr.Show();
        }
    }
}
